...
( function() {
	 ...
	 */
	registerBlockType( 'better-click-to-tweet/click-to-tweet', { // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
		title: __( 'Better Click To Tweet', 'better-click-to-tweet' ), // Block title.
		...
		edit: function( props ) {
			...
			return el(
				...
				{ // Creates <div class="wp-block-click-to-tweet"><a></a></div>
					tagName: 'a', // <a></a>.
					...
					focus: focus, // Focus — should be truthy. i.e. props.focus; I have set it null to disable the toolbar. Hacky. There must be a better way.
					onFocus: props.setFocus,
					//placeholder: __( 'Text for readers to tweet', 'better-click-to-tweet' ) // Commented coz of a CSS issue probably will be fixed in future Gutenberg versions.
				}
			);
		},
